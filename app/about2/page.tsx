      ...
      <section>
        <Container className="mx-auto flex flex-col">
          ...
          <div
            ...
            className="mt-10 grid grid-cols-1 gap-3 gap-x-10 rounded-3xl bg-white/[.68] backdrop-blur-[23px] laptop:grid-cols-2 laptop:px-[40px]"
          ...
          >
            {team.map((mate: any) => (
              ...
              >
                <div className="mt-4 flex h-auto w-full justify-center ">
                  <Image
                    src={mate.avatar}
                    width={mate.width}
                    height={mate.height}
                    ...
                    // rounded-t-3xl
                    className="aspect-[1/1] h-auto w-80  rounded-full object-cover shadow-sm"
                ...
                <div className="flex w-full flex-col justify-start  px-4 pb-4">
                  ...
                  <ul role="list" className="mt-10 flex items-center  gap-x-6 ">
                    <li>
                      <a
