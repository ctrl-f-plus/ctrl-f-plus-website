...
author: 'Ben Chavez'
description: 'Learn how to manage shared state across content scripts in a Chrome extension using a background script as a controller.'
summary: 'An article about managing shared state across content scripts in a Chrome extension.'
publishedAt: '2050-09-19'
updatedAt: '2050-09-19'
---
