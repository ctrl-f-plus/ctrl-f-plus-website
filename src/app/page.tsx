          ...
          >
            ...
            <div className="hidden lg:flex lg:gap-x-12">
              <Navigation
                items={navigation}
                itemClassName={
                  'text-sm font-semibold leading-6 text-glacier-950 hover:text-glacier-600'
                }
              />
            </div>
            <div className="hidden lg:flex lg:flex-1 lg:justify-end">
              <a
                href="#"
                className="text-sm font-semibold leading-6 text-glacier-950 hover:text-glacier-600"
              >
                Log in
              </a>
            </div>
          ...
          <div className="relative pt-14 ">
            ...
            <div className="py-24 sm:py-32 ">
              <div className="mx-auto max-w-7xl px-6 lg:px-8 ">
                <div className="relative w-full h-full flex items-center justify-center bg-red-500">
                  <span className="w-1/2 h-auto flex items-center justify-center ">
                    <img
                      src="/Asset 2.svg"
                      className="absolute left -top-24 w-3/5 h-auto rounded-md opacity-80 -rotate-12 "
                    />
                  </span>
                </div>
