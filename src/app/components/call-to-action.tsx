  ...
  return (
    <>
      ...
      {/* <Container
        ...
        >
          <div
            className=" z-10 flex h-[32.8125rem]  flex-col items-center justify-center  gap-9 rounded-[2.25rem] bg-dark1 px-[2.25rem] text-center"
            // className="relative isolate flex h-[32.8125rem] w-full flex-col items-center justify-center gap-9 rounded-[2.25rem] text-center"
          >
            <div className="absolute -top-24 right-10 -z-10 z-20 h-[14.6875rem] w-[17.875rem] flex-shrink-0 translate-x-1/2 rounded-full bg-[#8DBEDA] blur-[43.5px] filter" />
            <div className="absolute -bottom-24 left-10 -z-10   z-20 h-[14.6875rem] w-[17.875rem] flex-shrink-0 -translate-x-1/2 rounded-full bg-[#03AF7D] blur-[43.5px] filter" />
            <div
              data-atropos-offset="10"
              className=" z-10 flex h-full w-full flex-col items-center justify-center  gap-9 rounded-[2.25rem] bg-dark1 px-[2.25rem] text-center"
            >
              <h1 className="font-inter text-fs-x0 text-white tablet:text-fs-xl laptop:max-w-[31.9375rem]">
                Boost your productivity.
              </h1>
