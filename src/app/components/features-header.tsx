    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center gap-9 rounded-[2.25rem] bg-dark1 px-5 py-[4.5rem] text-center shadow-xl">
          ...
          <h3 className="gradient-text  max-w-[36.125rem] animate-gradient-x bg-gradient-to-r from-[#0021CD] via-[#F9F9F9] to-[#8CFFFF] bg-clip-text font-inter text-fs-x0 text-transparent tablet:text-fs-xl wide:text-text-dark">
