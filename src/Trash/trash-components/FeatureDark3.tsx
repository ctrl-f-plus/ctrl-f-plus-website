...
export default function FeatureDark3() {
  return (
    <div>
      <div className="bg-gray-900 mt-32 sm:mt-56 sm:py-32">
        <div className="py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="text-base font-semibold leading-7 text-peach-500">
              ...
              {features.map((feature) => (
                <div key={feature.name} className="relative pl-9 ">
                  <dt className="inline font-semibold text-white underline decoration-wavy decoration-accent0">
                    <feature.icon
                      className="absolute left-1 top-1 h-5 w-5 text-peach-500"
                      aria-hidden="true"
                    />
                    {feature.name}
                  </dt>{' '}
